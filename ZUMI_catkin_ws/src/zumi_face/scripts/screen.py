...
class Screen:
    ...
    def hello(self):
        self.draw_image(self.path_to_image(self.EYE_IMAGE_FOLDER_PATH + "gg.ppm"))
...
#### U make me
    def upward(self):
        self.draw_image_by_name("U")
    def downward(self):
        self.draw_image_by_name("D")
    def reward(self):
        self.draw_image_by_name("R")
    def leftward(self):
        self.draw_image_by_name("L")
    def ccw(self):
        self.draw_image_by_name("CCW")
    def cw(self):
        self.draw_image_by_name("CW")
    def start(self):
        self.draw_image_by_name("Start")
    def theend(self):
        self.draw_image_by_name("END")
    def normalface(self):
        self.draw_image_by_name("normalface")
    def heart(self):
        self.draw_image_by_name("Heart")
    def smile(self):
        self.draw_image_by_name("Smile")
    def idk(self):
        self.draw_image_by_name("IDK")
    def music(self):
        self.draw_image_by_name("Music")
    def Nop(self):
        self.draw_image_by_name("No")
